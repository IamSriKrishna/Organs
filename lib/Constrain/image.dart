class Image{
  ...
  final String x = 'asset/social/twitter.png';
  final String uTube = 'asset/social/uTube.png';
  final String linkedIn = 'asset/social/linkedIn.png';
  final String insta = 'asset/social/insta.png';
  final String meta = 'asset/social/facebook.png';
}